...
//  Enstagram
//
//  Created by Houyling Ung on 3/12/22.
//
...
//            }
    ...
    @IBAction func onLogoutButton(_ sender: Any) {
        ...
        guard let windowScence = UIApplication.shared.connectedScenes.first as? UIWindowScene, let deligate = windowScence.delegate as? SceneDelegate else {return}
        
        deligate.window?.rootViewController = loginViewController
